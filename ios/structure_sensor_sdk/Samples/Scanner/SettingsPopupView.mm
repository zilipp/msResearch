...
@implementation SettingsListModal
{
    ...
    UISwitch* depthResolutionSwitch;
...
- (void) setupUIComponentsAndLayout
{
    ...
    // Streaming settings
    {
        UILabel* depthResolutionLabel = [[UILabel alloc] init];
        depthResolutionLabel.translatesAutoresizingMaskIntoConstraints = NO;
        depthResolutionLabel.font = [UIFont systemFontOfSize:17.0 weight:UIFontWeightMedium];
        depthResolutionLabel.textColor = colorFromHexString(@"3A3A3C");
        depthResolutionLabel.text = @"Stream VGA Depth";
        [streamingSettingsView addSubview:depthResolutionLabel];

        [depthResolutionLabel.superview
         addConstraints:@[// Pin top of high-res color label to top of superview with offset
             [NSLayoutConstraint constraintWithItem:depthResolutionLabel
                                          attribute:NSLayoutAttributeTop
                                          relatedBy:NSLayoutRelationEqual
                                             toItem:depthResolutionLabel.superview
                                          attribute:NSLayoutAttributeTopMargin
                                         multiplier:1.0
                                           constant:0.0],
        ...
        depthResolutionSwitch = [[UISwitch alloc] init];
        depthResolutionSwitch.translatesAutoresizingMaskIntoConstraints = NO;
        depthResolutionSwitch.userInteractionEnabled = YES;
        depthResolutionSwitch.onTintColor = colorFromHexString(@"#00C3FF");
        [streamingSettingsView addSubview:depthResolutionSwitch];

        [depthResolutionSwitch.superview
         addConstraints:@[// Align centre Y of switch to centre Y of corresponding label
             [NSLayoutConstraint constraintWithItem:depthResolutionSwitch
                                          attribute:NSLayoutAttributeCenterY
                                          relatedBy:NSLayoutRelationEqual
                                             toItem:depthResolutionLabel
                                          attribute:NSLayoutAttributeCenterY
                                         multiplier:1.0
                                           constant:0.0],
             ...
             [NSLayoutConstraint constraintWithItem:depthResolutionSwitch
                                          ...
                                          relatedBy:NSLayoutRelationEqual
                                             toItem:depthResolutionSwitch.superview
                                          attribute:NSLayoutAttributeTrailingMargin
                                         multiplier:1.0
                                           constant:0.0]]];

        UIView* streamingHR0 = createHorizontalRule(1.0);
        streamingHR0.backgroundColor = colorFromHexString(@"#979797");
        [streamingSettingsView addSubview:streamingHR0];

        [streamingHR0.superview
         addConstraints:@[// Pin top of hr1 to bottom of streaming settings label with offset
             [NSLayoutConstraint constraintWithItem:streamingHR0
                                          attribute:NSLayoutAttributeTop
                                          relatedBy:NSLayoutRelationEqual
                                             toItem:depthResolutionLabel
                                          attribute:NSLayoutAttributeBottom
        ...
        streamPresetSegmentedControl = [[UISegmentedControl alloc] initWithItems:@[@"Default", @"Body", @"Outdoors", @"Hybrid"]];
...
{
    [depthResolutionSwitch addTarget:self
...
- (void) streamingOptionsDidChange:(id)sender
{
    ...
    switch (streamPresetSegmentedControl.selectedSegmentIndex)
    {
        ...
        case 2:
            ...
            break;
        case 3:
            presetMode = (STCaptureSessionPreset)5;
            break;
        default:
    ...
    [_delegate streamingSettingsDidChange:highResolutionColorSwitch.on
                           streamVGADepth:depthResolutionSwitch.on
